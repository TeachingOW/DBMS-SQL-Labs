...
- **Markdown files** (e.g., `Lab_Case_Expression.md`): New format, easier to edit
...
The project is maintained by [@TeachingOW](https://github.com/TeachingOW) and [@khalefa-ow](https://github.com/khalefa-ow), with contributions from the community. See [CONTRIBUTORS.md](CONTRIBUTORS.md).
