...
1. **Lab 1**: [Database Creation & Basic Queries](../labs/html_labs/InClassExercises.html)
   - Learn to create databases and tables
   - Master SELECT statements
   - Understand basic data types

2. **In-Class Exercise**: [Workers Database](../In-Class%20Exercise)
   - Practice CREATE TABLE and INSERT
   - Apply what you learned in Lab 1

3. **Lab 2**: [Advanced Queries & Joins](../labs/html_labs/Lab2.html)
   - Multi-table queries
   - JOIN operations
...
1. **Lab 7**: [CASE Expressions](../Lab_Case_Expression.md)
2. **Lab 8**: [Window Functions](../labs/html_labs/Lab4.html)
3. **Lab 9**: [Views](../labs/html_labs/Lab5_views.html)

### For Advanced Users
Jump to these advanced topics:

1. **Lab 16**: [Triggers & Stored Procedures](../labs/html_labs/Triggers.html)
2. **Lab 17**: [Transaction Management](../labs/html_labs/Transactions.html)
3. **Lab 20**: [MongoDB (NoSQL)](../labs/html_labs/Lab10_mongoDB.html)
4. **Lab 21**: [Neo4j (Graph Database)](../labs/html_labs/Lab11_neo4j.html)
...
1. ✅ Start with [Lab 1: Basic Queries](../labs/html_labs/InClassExercises.html)
2. ✅ Complete the [In-Class Exercise](../In-Class%20Exercise)
